...
"Key variables", also called "implicit identifier" or "quasi-identifier", are defined as a set of variables that, when considered together, can be used to identify individual patients. Here we are treating all 1,287 variables to be key variables. 
